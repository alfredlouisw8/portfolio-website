	...
	return (
		...
		>
			...
			<div className="flex flex-col space-y-5 md:space-y-10 w-full ">
				<h4 className="text-xl md:text-4xl font-semibold text-center mt-10">
					I have got just what you need.{" "}
					<span className="decoration-[#F7AB0A]/50 underline">Lets Talk.</span>
				</h4>

				<div className="flex justify-between lg:flex-row flex-col lg:space-x-10 lg:space-y-0 space-x-0 space-y-5">
					<div className="flex items-center  md:space-x-5 space-x-0 justify-center">
				...
				>
					...
					<button
						type="submit"
						className="
            bg-[#F7AB0A] md:py-5 md:px-10 px-5 py-2.5 rounded-md text-black font-bold text-lg "
					>
						Submit
					</button>
				</form>
